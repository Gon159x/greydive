    ...
    <div className={Style.formCard}>
        <Container fluid >
            <Row>
                ...
                {showForm ? <p style={readOnly? {display:'none'}:{color:'red',display:'flex',justifyContent:'flex-start'}}>Los campos con * son obligatorios</p> : <p style={{color:'#9f804b',display:'flex',justifyContent:'flex-start'}}>Ruta de sus datos /form/{id}.</p> }
            </Row>
